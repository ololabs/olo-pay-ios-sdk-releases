...
class UITestingIdentifiers {
    class TestHarness {
        ...
        public static let lineItemsView : String = "TestHarness.LineItemsView"
    }
    ...
    class Settings {
        ...
        public static let useLoggedInUserToggle: String = "Settings.UseLoggedInUser"
        public static let userPasswordTextField: String = "Settings.UserPasswordTextField"
        public static let userSavedCardBillingSchemeIdTextField: String = "Settings.UserSavedCardBillingSchemeIdTextField"
        public static let displayLineItemsToggle: String = "Settings.DisplayLineItemsToggle"
    }
}
