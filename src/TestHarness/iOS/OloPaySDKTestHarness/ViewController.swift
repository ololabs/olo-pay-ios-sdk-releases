...
class ViewController: UIViewController, OPApplePayContextDelegate, OPPaymentCardDetailsViewDelegate, OPPaymentCardDetailsFormDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        _applePayButton.backgroundColor = .systemBlue
        ...
        _clearLogButton.backgroundColor = .systemBlue
        ...
        let constraints = [
            stackView.topAnchor.constraint(equalToSystemSpacingBelow: view.safeAreaLayoutGuide.topAnchor, multiplier: 1.0),
            stackView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            stackView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            stackView.bottomAnchor.constraint(equalToSystemSpacingBelow: view.safeAreaLayoutGuide.bottomAnchor, multiplier: 1.0),
