...
class SettingsViewController : UIViewController, UITextFieldDelegate {
    ...
    @objc func completePaymentToggled() {
        ...
        _emailTextField.isEnabled = completePayment
        _apiUrlTextField.isEnabled = completePayment
        _apiKeyTextField.isEnabled = completePayment
        _restaurantIdTextField.isEnabled = completePayment
        _productIdTextField.isEnabled = completePayment
        _productQtyTextField.isEnabled = completePayment
    }
