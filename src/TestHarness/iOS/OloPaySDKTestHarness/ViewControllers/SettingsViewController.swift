...
class SettingsViewController : UIViewController, UITextFieldDelegate {
    ...
    func createScrollingStack(scrollView: UIScrollView) {
        ...
        createCvvTokenSection(scrollStack)
    ...
    func createCvvTokenSection(_ scrollStack: UIStackView) {
        scrollStack.addArrangedSubview(createSectionHeader(title: "CVV Token Settings"))
        ...
        scrollStack.addArrangedSubview(logCvvInputRow)
        ...
        scrollStack.addArrangedSubview(displayCvvErrorsRow)
        ...
        scrollStack.addArrangedSubview(customCvvErrorMessagesRow)
        
        
        scrollStack.setCustomSpacing(30, after: customCvvErrorMessagesRow)
    }
