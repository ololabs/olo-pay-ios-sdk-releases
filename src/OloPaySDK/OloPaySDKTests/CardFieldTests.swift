...
class CardFieldTests : XCTestCase {
    ...
    func testConvertFrom_OloPayCardField_To_String() throws {
        let cases = [(OPCardField.number, "number"), (OPCardField.expiration, "expiration"), (OPCardField.cvc, "cvc"), (OPCardField.postalCode, "postalCode"), (OPCardField.unknown, "unknown")]
        cases.forEach {
