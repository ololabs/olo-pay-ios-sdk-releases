...
class CardErrorTypeTests: XCTestCase {
    ...
    func testFrom_STPCardErrorType_to_CardErrorType() throws {
        let cases = [(STPCardErrorCode.cardDeclined, OPCardErrorType.cardDeclined), (STPCardErrorCode.expiredCard, OPCardErrorType.expiredCard),
                     (STPCardErrorCode.incorrectCVC, OPCardErrorType.incorrectCVC), (STPCardErrorCode.incorrectZip, OPCardErrorType.incorrectZip),
                     (STPCardErrorCode.incorrectNumber, OPCardErrorType.incorrectNumber), (STPCardErrorCode.invalidCVC, OPCardErrorType.invalidCVC),
