...
class OloPayAPITests: XCTestCase {
    ...
    func testCreatePaymentMethod_apiInitialized_invalidPublishableKey_updatesKey() throws {
        ...
        initializer!.setup(with: OPSetupParameters(withEnvironment: OPEnvironment.test)) {
    ...
    func testCreatePaymentMethod_apiInitialized_paymentParamsUnsupportedCardBrand_throwsException() throws {
        ...
        initializer!.setup(with: OPSetupParameters(withEnvironment: OPEnvironment.test)) {
            OloPayAPI().createPaymentMethod(with: PaymentMethodParamsHelper.createWithUnsupportedCardBrand()) { pm, e in
                paymentMethod = pm
                error = e
                expectation.fulfill()
            }
    ...
    func testCreatePaymentRequest_companyNotSet_throwsMissingCompanyLabelError() throws {
        ...
        initializer!.setup(with: OPSetupParameters(withEnvironment: OPEnvironment.test, withApplePayMerchantId: "com.olopay.tests")) {
            expectation.fulfill()
        }
    ...
    private class PaymentMethodParamsHelper {
        ...
        static func createWithUnsupportedCardBrand() -> OPPaymentMethodParamsProtocol {
            let paymentMethod = createStripePaymentMethod()
