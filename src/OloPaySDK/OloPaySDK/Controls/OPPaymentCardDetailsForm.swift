...
@objc public class OPPaymentCardDetailsForm : UIView, STPCardFormViewDelegate {
    ...
    func setupViews() {
        ...
        let constraints = [
            _form.centerXAnchor.constraint(equalTo: centerXAnchor),
            _form.centerYAnchor.constraint(equalTo: centerYAnchor),
            _form.widthAnchor.constraint(equalTo: widthAnchor),
            _form.heightAnchor.constraint(equalTo: heightAnchor),
        ]
    ...
    @objc public override func layoutSubviews() {
        _form.setNeedsLayout()
        _form.layoutIfNeeded()
    }
